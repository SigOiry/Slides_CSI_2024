...
::: {.fragment .absolute .fade-in bottom="15%" left="2%" data-id="TextSoft" fragment-index="1"}
[Aveiro Lagoon, Portugal]{style="color: black; font-size: 40px"}
:::

::: {.fragment .absolute .fade-in bottom="15%" left="52%" fragment-index="1"}
...
::: {.absolute data-id="SpectralSignature" .fragment .fade-out fragment-index="1" top="14%" left="-8%"}
![](Images/Figure_Hyperspectral.png){height="680"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-in fragment-index="1" top="14%" left="-8%"}
![](Images/Figure_Hyperspectral_faded.png){height="680"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-out fragment-index="1" top="10.5%" right="-8%"}
![](Images/Disc_Pigment_Table.png){height="700"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-in fragment-index="1" top="10.5%" right="-8%"}
![](Images/Disc_Pigment_Table_faded.png){height="700"}
:::
...
::: {.absolute data-id="SpectralSignature" top="45%" left="-10%"}
![](Images/Figure_Hyperspectral_Instru.png){height="680"}
:::
...
::: {.absolute top="45%" data-id="SpectralSignatureGIF" right="-10%"}
![](Images/Spectra_resampled_gif.gif){height="680"}
:::
...
::: {.absolute data-id="SpectralSignatureGIF" top="45%"  left="-10%"}
![](Images/Spectra_resampled_gif.gif){height="680"}
:::



::: {.absolute .fragment .fade-in fragment-index="2" top="30%" right="-10%"}
![](Images/spectro.jpg){height="620"}
:::

::: {.absolute .fragment .fade-in fragment-index="2" top="25%" left="50%"}
![](Images/Sites_Bede.png){height="850"}
:::
...
::: {.absolute top="10%" .fragment .fade-out fragment-index="4" right="-10%"}
![](Images/Spectra_distance_gif.gif){height="800"}
:::
:::

::: {.absolute top="10%" .fragment .fade-in fragment-index="4" right="-10%"}
