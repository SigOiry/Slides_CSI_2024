...
::: {.absolute data-id="SpectralSignature" .fragment .fade-out fragment-index="1" top="14%" left="-2%"}
![](Images/Figure_Hyperspectral.png){height="630"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-in fragment-index="1" top="14%" left="-2%"}
![](Images/Figure_Hyperspectral_faded.png){height="630"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-out fragment-index="1" top="12%" right="-2%"}
![](Images/Disc_Pigment_Table.png){height="630"}
:::

::: {.absolute data-id="SpectralSignature" .fragment .fade-in fragment-index="1" top="12%" right="-2%"}
...
::: {.absolute data-id="SpectralSignatureGIF" top="45%"  left="-2%"}
![](Images/Spectra_resampled_gif.gif){height="680"}
:::
...
::: {.absolute top="10%" .fragment .fade-out fragment-index="4" right="-2%"}
![](Images/Spectra_distance_gif.gif){height="800"}
:::
:::

::: {.absolute top="8%" .fragment .fade-in fragment-index="4" right="-2%"}
