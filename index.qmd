...
## Hyperspectral {auto-animate="true" style="font-size: 60px;"}
...
::: {.absolute data-id="SpectralSignature" top="16%" left="-8%"}
![](Images/Figure_Hyperspectral.png){height="680"}
:::

::: {.absolute data-id="SpectralSignature" top="12.5%" right="-8%"}
![](Images/Disc_Pigment_Table.png){height="700"}
:::

::: {.absolute bottom="0%" left="0%"}
![](Images/Pheophyceae_cropped.png){height="250"}
:::

::: {.absolute bottom="0%" left="20%"}
![](Images/Chlorophyceae_cropped.png){height="250"}
:::

::: {.absolute bottom="0%" left="40%"}
![](Images/Magnoliopsida_cropped.png){height="250"}
:::

::: {.absolute bottom="0%" left="60%"}
![](Images/Bacillariophyceae_cropped.png){height="250"}
:::

::: {.absolute bottom="0%" left="80%"}
![](Images/Rodophyceae_cropped.png){height="250"}
:::
