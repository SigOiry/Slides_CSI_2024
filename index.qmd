...
::: {.absolute .fragment .fade-out fragment-index="1" top="10%" left="0%"}
![](Images/Intertidal_Chambers.png){height="600"}
:::

::: {.absolute .fragment .fade-in-then-out fragment-index="1" top="10%" left="0%"}
![](Images/Intertidal_Chambers2.png){height="600"}
:::

<div class="absolute fragment fade-in" data-fragment-index="2" style="top: 10%; left: 0%; ">
<video id="droneVideo" muted autoplay height="600">
